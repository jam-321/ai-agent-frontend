...
async function create() {
  if (props.mode === 'agents') { editing.value = {}; editingExisting.value = false; form.value = { agentKey: '', executionType: 'LOOP', modelProviderKey: 'deepseek', modelName: 'deepseek-v4-flash', modelTemperature: 0.7, enabledPlugins: '[]', enabledTools: 'null', magicParams: '{}' }; return }
